...
(function () {
  ...
  var Ga = !1,
    ...
    pa = {
      ...
      Toolbar: {
        ...
        itemBackgroundColorOnHover: "#728FCE",
        buttonBorderColor: "#728FCE",
  ...
  y = Oa.Chart = (function () {
                ...
                (b =
                  0 <= n.indexOf("range") || "error" === n
                    ...
                    : (Math.max(m.bounds.y1, c.y1) +
                      ...
                      ("horizontal" === C ? t : 0)),
                0 < v
                  ? ((h = Math.max(m.point.y, b)),
                    h < e &&
                      ("bubble" === n || "scatter" === n) &&
                      (h = Math.max(m.point.y - k - t, c.y1 + t)))
                  : ((h = Math.min(m.point.y, b)),
                    h > f - k - t &&
                      ("bubble" === n || "scatter" === n) &&
                      (h = Math.min(m.point.y + t, c.y2 - k - t))),
                (h = Math.min(h, f)));
          } else
            0 <= n.indexOf("line") ||
            0 <= n.indexOf("area") ||
                  ...
                  0 > v
                    ? ((q =
                      ...
                      q < e &&
                        ...
                        (y = q + B > m.point.x)))
                    : ((q =
                        m.point.x + ("horizontal" === C ? 0 : r / 2) + p + b),
                      q > f - B - p - b &&
                        ((q =
                          "auto" === A
            ...
            for (var h = (f = 0); f < d.length - 3; f += 3, h++) {
              if (l[h].newStrokeStyle || l[h].newLineDashArray)
                b.stroke(),
                  b.beginPath(),
                  b.moveTo(d[f].x, d[f].y),
                  l[h].newStrokeStyle && (b.strokeStyle = l[h].newStrokeStyle),
                  l[h].newLineDashArray && b.setLineDash(l[h].newLineDashArray);
              b.bezierCurveTo(
                d[f + 1].x,
                d[f + 1].y,
                d[f + 2].x,
          ...
          if (c && 0 < c.length)
            for (y = [], h = O = 0; h < c.length; h++)
              y.push(
                ...
                (O += y[h]),
                (L += c[h] && !m.isNavigator ? c[h].margin : 0);
          else
            ...
            for (h = 0; h < a.length; h++) {
              ...
              if (b && 0 < b.length)
                for (L = 0; L < b.length; L++)
                  b[L] &&
                    b[L].labelAutoFit &&
                    ((l = b[L].lineCoordinates.x1), (p = l - X));
              a[h].lineCoordinates = {
                x1: l - P,
                y1: g,
                x2: l - P,
            ...
            for (h = 0; h < d.length; h++) {
              ...
              if (b && 0 < b.length)
                for (L = 0; L < b.length; L++)
                  b[L] &&
                    b[L].labelAutoFit &&
                    ((l = b[L].lineCoordinates.x2), (p = l - T));
              d[h].lineCoordinates = {
                x1: l + R,
                y1: g,
                x2: l + R,
        ...
        if (this.scaleBreaks && !s(this.scaleBreaks.firstBreakIndex))
          if (s(this.scaleBreaks.lastBreakIndex))
            ...
            for (
              ...
              d.moveTo(g, e),
                d.lineTo(g, this.scaleBreaks._appliedBreaks[l].startPixel + b),
    ...
    X.prototype.getToolTipInnerHTML = function (a) {
      a = a.entries;
      for (
        var d = null, c = null, b = null, e = 0, f = "", g = !0, l = 0;
        l < a.length;
        l++
      )
